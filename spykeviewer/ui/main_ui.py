...
"}"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/Analyses/New")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNewPlugin.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/Analyses/Edit")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEditPlugin.setIcon(icon2)
        self.actionEditPlugin.setObjectName(_fromUtf8("actionEditPlugin"))
        self.actionRefreshPlugins = QtGui.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/Analyses/Reload")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRefreshPlugins.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/Analyses/Save")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSavePlugin.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/Analyses/Config")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConfigurePlugin.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/Analyses/Run")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRunPlugin.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/Analyses/Remote")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemotePlugin.setIcon(icon7)
        self.actionRemotePlugin.setObjectName(_fromUtf8("actionRemotePlugin"))
        self.actionNewFilter = QtGui.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/Filter/New Filter")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNewFilter.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/Filter/Copy Filter")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCopyFilter.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/Filter/Edit Filter")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEditFilter.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/Filter/Remove Filter")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDeleteFilter.setIcon(icon11)
